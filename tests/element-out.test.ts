...
test.each([
  ...
  [10, '<div></div>',
       '<div></div>'],
  [11, '<div class="a"></div><div class="b"></div><div class="c"></div>',
        '<div class="a"></div><div class="b"></div><div class="c"></div>'],
  [12, '<div class="a">123</div><div class="b">hogefuga</div><div class="c"><a href="example">piyopiyo</a></div>',
       '<div class="a">123</div><div class="b">hogefuga</div><div class="c"><a href="example">piyopiyo</a></div>'],
  [21, '<div class="type-{{baz}}">{{name}}</div>',
       '<div class="type-foo1234">hoge</div>'],
  [22, '<div>Name: {{name}}</div>',
       '<div>Name: hoge</div>'],
  [23, '<div class="type-{{baz}}">Name: <span class="name-value">{{name}}</span></div>',
       '<div class="type-foo1234">Name: <span class="name-value">hoge</span></div>'],
  [24, '<div id="information" class="infomation"><div class="info-name">Name: {{name}}</div><div class="info-view" data-value="{{view-count}}">{{view-count}} views.</div></div>',
  ...
  [25, '<dl id="info"><dt class="name">Name</dt><dd>{{name}}</dd><dt class="view" data-view-count="{{view-count}}">View</dt><dd>{{view-count}} views.</dd><dt class="pos">Position</dt><dd data-x="{{p.x}}" data-y="{{p.y}}" data-z="{{p.z}}">({{p.x}}, {{p.y}}, {{p.z}})</dd></dl>',
  ...
  [26, '<dt class="name">Name</dt><dd>{{name}}</dd><dt class="view" data-view-count="{{view-count}}">View</dt><dd>{{view-count}} views.</dd><dt class="pos">Position</dt><dd data-x="{{p.x}}" data-y="{{p.y}}" data-z="{{p.z}}">({{p.x}}, {{p.y}}, {{p.z}})</dd>',
  ...
  [31, '<div class="type-{{baz}}">Name: <span class="name-value">{{name}}</span></div><div class="location" data-pos="{{p.x}} {{p.y}} {{p.z}}" style="color:rgba({{color.rgb.r}}, {{color.rgb.g}}, {{color.rgb.b}}, 1.0)" title="My location">Located at ({{p.x}}, {{p.y}}, {{p.z}}).</div>',
